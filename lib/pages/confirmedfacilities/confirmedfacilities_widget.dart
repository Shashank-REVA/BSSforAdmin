...
import 'confirmedfacilities_model.dart';
export 'confirmedfacilities_model.dart';

class ConfirmedfacilitiesWidget extends StatefulWidget {
  const ConfirmedfacilitiesWidget({
    super.key,
    Color? btnclr,
    Color? btntxt,
  ...
  @override
  State<ConfirmedfacilitiesWidget> createState() =>
      _ConfirmedfacilitiesWidgetState();
}

class _ConfirmedfacilitiesWidgetState extends State<ConfirmedfacilitiesWidget> {
  late ConfirmedfacilitiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmedfacilitiesModel());
  }
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          ...
                                                          _model.apiResulttlt =
                                                              await CancelCall
                                                                  .call(
                                                            email: listViewConFacilityRecord
                                                                .conGuestEmail,
                                                          );
                                                          if ((_model
                                                                  .apiResulttlt
